...
Write-Host 'Each run writes a manifest, console log, periodic checkpoints, metrics, and AP-small evaluation.'
Write-Host 'Keep this window open and prevent the computer from sleeping.' -ForegroundColor Yellow

& .\.venv\Scripts\python.exe .\src\run_recorded_experiment.py `
    --variant baseline `
